 ...
 *
 */
extern bool ts_parse_str_mac(const char *str, struct ether_addr *mac);
 ...
 *
 */
extern bool ts_parse_str_dst_mac(const char *name_key, const char *val_key,
 ...
 *
 */
extern bool ts_parse_str_src_mac(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_src_ipv4(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_dst_ipv4(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_src_ipv6(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_dst_ipv6(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_ip_protocol(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_ether_type(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_src_tcp(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_dst_tcp(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_src_udp(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_dst_udp(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_vlan_id(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
 ...
 *
 */
extern bool ts_parse_str_interface(const char *name_key, const char *val_key,
    struct filter *new_filter, char *message, size_t message_len);
